...
@Tag(name = "filteredSelectItems")
@UIComponentTag(
    uiComponent = "org.apache.myfaces.tobago.component.UIFilteredSelectItems",
    uiComponentFacesClass = "javax.faces.component.UISelectItems",
    rendererType = RendererTypes.FILTERED_SELECT_ITEMS,
    allowedChildComponents = "NONE")
public interface FilteredSelectItemsTagDeclaration extends HasId, HasBinding, HasItemLabel {
